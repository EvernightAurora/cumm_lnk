...
class InputSimtDepthwise(bases.Input):
    def __init__(self,
                 problem: ConvProblem,
        ...
        if tile_shape[2] <= 16:
            ...
            if problem.op_type == ConvOpType.kBackwardWeight:
        ...
        if self.alignment_b > 1:
            ...
            self.tmap_b = thread_map.PitchLinearMod(self.input_tile_shape_b,
...
class AlgoSpecificSimtDepthwise(object):
    def __init__(self,
        ...
        self.output_spec = OutputSimt(self.mma_spec,
                                      ...
                                      access_per_vector=access_per_vector,
                                      is_depthwise_wgrad=(problem.op_type == ConvOpType.kBackwardWeight))